...
public class OrdersVerificationTest extends RFWebsiteBaseTest{
	...
	public void testVerifyAdhocConsultantOrder_1934() throws InterruptedException{
		...
		cscockpitCheckoutTabPage.clickOkButtonPaymentInfoAutoShipFailedOrderPopupInCheckoutTab();
	...
	public void testVerifyUserPermissionsForOrderStatus_1779(){
		...
		driver.get(driver.getCSCockpitURL());
		//Login with commision Admin credential.
		cscockpitCustomerSearchTabPage = cscockpitLoginPage.clickLoginBtn(csCommisionAdminUserName,csCommisionAdminPassword);
		cscockpitCustomerSearchTabPage.selectCustomerTypeFromDropDownInCustomerSearchTab("CONSULTANT");
		cscockpitCustomerSearchTabPage.selectCountryFromDropDownInCustomerSearchTab(country);
		cscockpitCustomerSearchTabPage.selectAccountStatusFromDropDownInCustomerSearchTab("Active");
		cscockpitCustomerSearchTabPage.clickSearchBtn();
		...
		driver.get(driver.getCSCockpitURL());
		//Login with Sales supervisory credential.
		cscockpitCustomerSearchTabPage = cscockpitLoginPage.clickLoginBtn(csSalesSupervisoryUserName,csSalesSupervisoryPassword);
		cscockpitCustomerSearchTabPage.selectCustomerTypeFromDropDownInCustomerSearchTab("CONSULTANT");
		cscockpitCustomerSearchTabPage.selectCountryFromDropDownInCustomerSearchTab(country);
		cscockpitCustomerSearchTabPage.selectAccountStatusFromDropDownInCustomerSearchTab("Active");
		cscockpitCustomerSearchTabPage.clickSearchBtn();
	...
	@Test(enabled=false)//Need required users
	...
	@Test
	public void testPlaceOrderFromCSCockpitForConsultant(){
		String randomCustomerSequenceNumber = null;
		String randomProductSequenceNumber = null;
	...
	public void testVerifyTheAbilityToMarkTestOrderAndDoNotShipFunctionality_1926(){
		...
		cscockpitCustomerTabPage.enterShippingInfoInAddNewPaymentProfilePopupWithoutSaveBtn(attendentFirstName, attendeeLastName, addressLine1, city, postalCode, countryDDValue, state, phoneNumber);
	...
	public void testVerifyTheDisplayOrderOrigination_1948() throws InterruptedException{
		...
		while(true){
			randomCustomerList = DBUtil.performDatabaseQuery(DBQueries_RFO.callQueryWithArguement(DBQueries_RFO.GET_RANDOM_ACTIVE_RC_HAVING_ORDERS_RFO,countryId),RFO_DB);
		...
		//		cscockpitCheckoutTabPage.clickSaveAddNewPaymentProfilePopUP();
		cscockpitCheckoutTabPage.enterCVVValueInCheckoutTab(CVV);
		cscockpitCheckoutTabPage.clickUseThisCardBtnInCheckoutTab();
		cscockpitCheckoutTabPage.clickPlaceOrderButtonInCheckoutTab();
	...
	public void testToVerifyAdhocRetailOrder_1942() throws InterruptedException{
		...
		if(driver.getCountry().equalsIgnoreCase("us")){
			...
			s_assert.assertTrue(cscockpitCheckoutTabPage.getDeliverModeTypeInCheckoutTab().contains("Standard Shipping-AUD"),"CSCockpit checkout tab delivery mode type expected = Standard Shipping-AUD and on UI = " +cscockpitCheckoutTabPage.getDeliverModeTypeInCheckoutTab()); 
		}
		cscockpitCheckoutTabPage.clickPlaceOrderButtonInCheckoutTab();
		s_assert.assertTrue(cscockpitCheckoutTabPage.verifySelectPaymentDetailsPopupInCheckoutTab(), "Select payment details popup is not present");
		cscockpitCheckoutTabPage.clickOkButtonOfSelectPaymentDetailsPopupInCheckoutTab();
		//cscockpitCheckoutTabPage.clickOkButtonToCloseWarningPopUp();
		cscockpitCheckoutTabPage.enterOrderNotesInCheckoutTab(TestConstants.ORDER_NOTE+randomNum);
		...
		String orderType = cscockpitCustomerTabPage.getOrderTypeInCustomerTab(orderNumber.split("\\-")[0].trim());
		s_assert.assertTrue(orderType.contains("Retail Order"),"CSCockpit Customer tab Order type expected = Retail Order and on UI = " +cscockpitCustomerTabPage.getOrderTypeInCustomerTab(orderNumber.split("\\-")[0].trim()));
		//		driver.get(driver.getStoreFrontURL()+"/"+driver.getCountry());
		//		storeFrontRCUserPage = storeFrontHomePage.loginAsRCUser(rcUserEmailID, password);
		//		storeFrontRCUserPage.clickOnWelcomeDropDown();
		//		storeFrontOrdersPage =  storeFrontRCUserPage.clickOrdersLinkPresentOnWelcomeDropDown();
	...
	public void testVerifyUserPermissionsForQVandCVUpdate_1818(){
		...
		randomOrderSequenceNumber = String.valueOf(cscockpitOrderSearchTabPage.getRandomOrdersFromOrderResultSearchFirstPageInOrderSearchTab());
		cscockpitOrderSearchTabPage.clickOrderNumberInOrderSearchResultsInOrderSearchTab(randomOrderSequenceNumber);
		s_assert.assertTrue(cscockpitOrderTabPage.isQVandCVUpdateBtnEnabledOnOrderTab(),"QV and CV update button is not disabled for "+TestConstants.CS_AGENT_USERNAME);
		//		driver.get(driver.getCSCockpitURL());
		//
		//		cscockpitCustomerSearchTabPage = cscockpitLoginPage.clickLoginBtn(csCommisionAdminUserName,csCommisionAdminPassword);
		//		cscockpitCustomerSearchTabPage.selectCustomerTypeFromDropDownInCustomerSearchTab("CONSULTANT");
		...
		//		cscockpitCustomerSearchTabPage.clickCIDNumberInCustomerSearchTab(randomCustomerSequenceNumber);
		//		cscockpitCustomerTabPage.clickFirstOrderInCustomerTab();
		//		s_assert.assertFalse(cscockpitOrderTabPage.isQVandCVUpdateBtnDisabledOnOrderTab(),"QV and CV update button is not disabled for "+TestConstants.CS_COMMISION_ADMIN_STG2_USERNAME);
		//		driver.get(driver.getCSCockpitURL());
		//
		//		cscockpitCustomerSearchTabPage = cscockpitLoginPage.clickLoginBtn(csSalesSupervisoryUserName,csSalesSupervisoryPassword);
		//		cscockpitCustomerSearchTabPage.selectCustomerTypeFromDropDownInCustomerSearchTab("CONSULTANT");
		...
		//		cscockpitCustomerSearchTabPage.clickCIDNumberInCustomerSearchTab(randomCustomerSequenceNumber);
		//		cscockpitCustomerTabPage.clickFirstOrderInCustomerTab();
		//		s_assert.assertFalse(cscockpitOrderTabPage.isQVandCVUpdateBtnDisabledOnOrderTab(),"QV and CV update button is not disabled for "+TestConstants.CS_SALES_SUPERVISORY_STG2_USERNAME);
	...
	public void testToVerifyForCreatedNewUserTheOrderStatusShouldBeSubmitted_1937(){
		...
		cscockpitCheckoutTabPage.clickPlaceOrderButtonInCheckoutTab();
		String newlyPlacedConsultantOrderNumber = cscockpitOrderTabPage.getOrderNumberFromCsCockpitUIOnOrderTab();
		String orderStatus = cscockpitOrderTabPage.getOrderStatusAfterPlaceOrderInOrderTab();
		s_assert.assertTrue(orderStatus.equalsIgnoreCase("submitted"), "Expected order status is submitted and actual on UI is "+orderStatus);
		//		cscockpitOrderTabPage.clickOrderSearchTab();
		//		cscockpitOrderSearchTabPage.enterOrderNumberInOrderSearchTab(newlyPlacedConsultantOrderNumber);
		//		cscockpitOrderSearchTabPage.clickSearchBtn();
		...
		cscockpitCheckoutTabPage.clickUseThisCardBtnInCheckoutTab();
		cscockpitCheckoutTabPage.clickPlaceOrderButtonInCheckoutTab();
		String orderStatusForPC = cscockpitOrderTabPage.getOrderStatusAfterPlaceOrderInOrderTab();
		s_assert.assertTrue(orderStatus.equalsIgnoreCase("submitted"), "Expected order status is for PC submitted and actual on UI is "+orderStatusForPC);
	...
	public void testVerifyCscockpitRefundOrderFunctionality_4073() throws InterruptedException{
		...
		if(driver.getCountry().equalsIgnoreCase("au")){
			s_assert.assertTrue(cscockpitOrderTabPage.isNoRefundableProductPresent(), "Order Number = "+orderNumber+" has NOT refund Successfully");
		}else{
	...
	@Test(enabled=false)//Needs required users
	public void testVerifyCommissionDateChangeFunctionalityInOrderDetailPage_1839(){
		...
		cscockpitCustomerSearchTabPage = cscockpitLoginPage.clickLoginBtn(TestConstants.CS_COMMISION_ADMIN_STG2_USERNAME,TestConstants.CS_AGENT_PASSWORD);
		cscockpitCustomerSearchTabPage.selectCustomerTypeFromDropDownInCustomerSearchTab("CONSULTANT");
		cscockpitCustomerSearchTabPage.selectCountryFromDropDownInCustomerSearchTab(countryDDValue);
		cscockpitCustomerSearchTabPage.selectAccountStatusFromDropDownInCustomerSearchTab("Active");
		cscockpitCustomerSearchTabPage.clickSearchBtn();
	...
	public void testToVerifyAdhocPCOrder_1941() throws InterruptedException{
		...
		cscockpitOrderTabPage.clickCustomerTab();
		String orderType = cscockpitCustomerTabPage.getOrderTypeInCustomerTab(orderNumber.split("\\-")[0].trim());
		s_assert.assertTrue(orderType.contains("PC Order")||orderType.contains("POS Order"),"CSCockpit Customer tab Order type expected = PC Order and on UI = " +cscockpitCustomerTabPage.getOrderTypeInCustomerTab(orderNumber.split("\\-")[0].trim()));
		//			driver.get(driver.getStoreFrontURL()+"/"+driver.getCountry());
		//			storeFrontPCUserPage = storeFrontHomePage.loginAsPCUser(pcUserEmailID, password);
		//			storeFrontPCUserPage.clickOnWelcomeDropDown();
		//			storeFrontOrdersPage =  storeFrontPCUserPage.clickOrdersLinkPresentOnWelcomeDropDown();
	...
	//Hybris Project-1952:To verify the Sales Override from Order detail Page
		...
		public void testVerifyTheSalesOverrideFromOrderDetailPage_1952() throws InterruptedException{
			...
			String pcEmailID = null;
			String rcEmailID = null;
			String orderNotevalueFromUI =null;
			String pstDate=null;
			...
			s_assert.assertTrue(cscockpitCheckoutTabPage.getValuesFromTotalsSection(deliveryCosts).contains(deliveryCost)
					|| cscockpitCheckoutTabPage.getValuesFromTotalsSection(deliveryCosts).split("\\$")[1].split("\\.")[0]
							.trim().contains(deliveryCost),
					"Expected delivery cost for consultant is " + deliveryCost + " Actual on UI is "
							+ cscockpitCheckoutTabPage.getValuesFromTotalsSection(deliveryCosts));
			s_assert.assertTrue(cscockpitCheckoutTabPage.getValuesFromTotalsSection(handlingCosts).contains(handlingCost),
					"Expected handling cost for consultant is " + handlingCost + " Actual on UI is "
							+ cscockpitCheckoutTabPage.getValuesFromTotalsSection(handlingCosts));
			s_assert.assertTrue(cscockpitCheckoutTabPage.getValuesFromTotalsSection(totalCV).contains(cvValue),
					"Expected CV value for consultant is " + cvValue + " Actual on UI is "
							+ cscockpitCheckoutTabPage.getValuesFromTotalsSection(totalCV));
			s_assert.assertTrue(cscockpitCheckoutTabPage.getValuesFromTotalsSection(totalQV).contains(qvValue),
					"Expected QV value for consultant is " + qvValue + " Actual on UI is "
							+ cscockpitCheckoutTabPage.getValuesFromTotalsSection(totalQV));
			...
			s_assert.assertTrue(cscockpitCheckoutTabPage.getValuesFromTotalsSection(deliveryCosts).contains(deliveryCost)
					|| cscockpitCheckoutTabPage.getValuesFromTotalsSection(deliveryCosts).split("\\$")[1].split("\\.")[0]
							.trim().contains(deliveryCost),
					"Expected delivery cost for PC is " + deliveryCost + " Actual on UI is "
							+ cscockpitCheckoutTabPage.getValuesFromTotalsSection(deliveryCosts));
			s_assert.assertTrue(cscockpitCheckoutTabPage.getValuesFromTotalsSection(handlingCosts).contains(handlingCost), "Expected handling cost for PC is "+handlingCost+" Actual on UI is "+cscockpitCheckoutTabPage.getValuesFromTotalsSection(handlingCosts));
			s_assert.assertTrue(cscockpitCheckoutTabPage.getValuesFromTotalsSection(totalCV).contains(cvValue), "Expected CV value for PC is "+cvValue+" Actual on UI is "+cscockpitCheckoutTabPage.getValuesFromTotalsSection(totalCV));
			s_assert.assertTrue(cscockpitCheckoutTabPage.getValuesFromTotalsSection(totalQV).contains(qvValue), "Expected QV value for PC is "+qvValue+" Actual on UI is "+cscockpitCheckoutTabPage.getValuesFromTotalsSection(totalQV));
			...
			cscockpitCheckoutTabPage.clickUpdateButtonSalesOverridePopUp();
			s_assert.assertTrue(
					cscockpitCheckoutTabPage.getValuesFromTotalsSection(deliveryCosts).split("\\$")[1].split("\\.")[0].trim()
							.contains(deliveryCost),
					"Expected delivery cost for RC is " + deliveryCost + " Actual on UI is "
							+ cscockpitCheckoutTabPage.getValuesFromTotalsSection(deliveryCosts).split("\\$")[1]
									.split("\\.")[0]);
			s_assert.assertTrue(cscockpitCheckoutTabPage.getValuesFromTotalsSection(handlingCosts).contains(handlingCost),
					"Expected handling cost for RC is " + handlingCost + " Actual on UI is "
							+ cscockpitCheckoutTabPage.getValuesFromTotalsSection(handlingCosts));
			s_assert.assertTrue(cscockpitCheckoutTabPage.getValuesFromTotalsSection(totalCV).contains(cvValue),
					"Expected CV value for RC is " + cvValue + " Actual on UI is "
							+ cscockpitCheckoutTabPage.getValuesFromTotalsSection(totalCV));
			s_assert.assertTrue(cscockpitCheckoutTabPage.getValuesFromTotalsSection(totalQV).contains(qvValue),
					"Expected QV value for RC is " + qvValue + " Actual on UI is "
							+ cscockpitCheckoutTabPage.getValuesFromTotalsSection(totalQV));
			cscockpitCheckoutTabPage.clickPlaceOrderButtonInCheckoutTab();
			s_assert.assertTrue(cscockpitOrderTabPage.getOrderStatusAfterPlaceOrderInOrderTab().contains("SUBMITTED"),
					"order is not submitted successfully");
			orderNumber = cscockpitOrderTabPage.getOrderNumberFromCsCockpitUIOnOrderTab();
			/*driver.get(driver.getStoreFrontURL()+"/"+driver.getCountry());
					storeFrontRCUserPage = storeFrontHomePage.loginAsRCUser(rcEmailID, password);
					storeFrontRCUserPage.clickOnWelcomeDropDown();
