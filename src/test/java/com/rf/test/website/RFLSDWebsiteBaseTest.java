...
/**
 * @author ShubhamMathur RFLSDWebsiteBaseTest is the super class for all
...
public class RFLSDWebsiteBaseTest extends RFBaseTest {
	...
	public void beforeClass() throws Exception{
		...
		randomConsultantList = DBUtil.performDatabaseQuery(DBQueries_RFO.GET_RANDOM_CONSULTANT,commDBName,Commisions_DB_IP);
		accountId = getAccountId(randomConsultantList);
	...
	private String getUserNmae(List<Map<String, Object>> randomConsultantList2) {
	...
	private String getAccountId(List<Map<String, Object>> randomConsultantList) {
...
//			driver.clickByJS(RFWebsiteDriver.driver, By.xpath("//div[@id='rf-nav-wrapper']/descendant::img[2]"), "R+F logo by JS");
	...
	public void initiateSoftAssertObject(){
		...
		lsdLoginPage.waitForPulseTopLinkToGetDisplayed();
		try{
			lsdLoginPage.enterUsername(userName);
			lsdLoginPage.enterPassword(password);
			lsdLoginPage.clickLoginBtn();
	...
	public void setLogger(String text) {
		logger.info(text);
	}
