...
public class DSVStoreFrontBillingInfoPage extends DSVRFWebsiteBasePage {
	...
	public void enterNewBillingProfileDetails(String cardNumber,String nameOnCard,String expiryMonth,String expiryYear,String securityCode) {
	...
	public boolean isBillingProfilePresentonPage(String billingName){
		...
		return driver.isElementVisible(By.xpath(String.format(BillingProfiles, billingName)));		
	}

	public boolean isBillingProfileRemovedMsgAppeared(){
		driver.quickWaitForElementPresent(BILLING_PROFILE_REMOVED_MSG);
		return driver.isElementVisible(BILLING_PROFILE_REMOVED_MSG);		
	}
	...
	public boolean areMoreBillingProfilesLeftForDeletion(){
		...
		driver.waitForElementPresent(By.xpath("//div[@id='multiple-billing-profiles']/descendant::a[contains(text(),'Delete')][1]"));
