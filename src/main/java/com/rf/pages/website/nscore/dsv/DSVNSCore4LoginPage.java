...
public class DSVNSCore4LoginPage extends DSVNSCore4RFWebsiteBasePage{
	private static final Logger logger = LogManager
			.getLogger(DSVNSCore4LoginPage.class.getName());

	public DSVNSCore4LoginPage(RFWebsiteDriver driver) {
		super(driver);
	...
	public DSVNSCore4HomePage clickLoginBtn(){
		driver.waitForCSCockpitLoadingImageToDisappear();
		driver.waitForElementPresent(LOGIN_BTN);
		driver.click(LOGIN_BTN,"");
		driver.waitForCSCockpitLoadingImageToDisappear();
		driver.pauseExecutionFor(3000);
		return new DSVNSCore4HomePage(driver);
	}
