...
public class NSCore4AdminPage extends NSCore4RFWebsiteBasePage{
	...
	private static String newAddedlistCancelMarkLoc = "//ul[@id='listValues']/li[%s]/a/img[contains(@alt,'Delete')]";
	...
	public boolean isNewListAdded(String newAddedListValue, int numberofListPresent) {
		driver.scrollUpIntoView(By.xpath(String.format(newlyAddedValue, numberofListPresent)));
