...
public class StoreFrontCreateAccountPage extends StoreFrontRFWebsiteBasePage{
	...
	public void closePopUp(){
		driver.click(By.cssSelector("a[title='Close']"),"close popup");
	}	
	...
	public void clickEnrollmentNextBtn(){
		driver.click(By.id("enrollment-next-button"),"enrollment next button");
	}

	public void acceptTheVerifyYourShippingAddressPop(){
		driver.waitForLoadingImageToDisappear();
		driver.click(By.id("QAS_RefineBtn"),"QAS accept button");
	}
	...
	public void checKThePoliciesAndProceduresCheckBox(){
		driver.click(By.xpath("//input[@id='policies-check']/.."),"policies checkbox");
	}

	public void checKTheIAcknowledgeCheckBox(){
		driver.click(By.xpath("//input[@id='acknowledge-check']/.."),"Acknowledge checkbox");
	}

	public void checKTheTermsAndConditionsCheckBox(){
		driver.click(By.xpath("//input[@id='terms-check']/.."),"terms and conditions checkbox");
	}

	public void checKTheIAgreeCheckBox(){
		driver.click(By.xpath("//input[@id='electronically-check']/.."), "e-check checkbox");
	}

	public void clickOnChargeMyCardAndEnrollMeBtn(){
		driver.click(By.id("enroll-button"),"charge and enroll me button");
	}

	public StoreFrontConsultantEnrollmentConfirmationPage clickOnConfirmAutomaticPayment() throws InterruptedException{
		driver.click(By.id("enroll"),"confirm automatic payment button");
