...
public class StoreFrontReportOrderComplaintPage extends StoreFrontRFWebsiteBasePage {
	...
	public void clickOnCheckBox(){
		...
		driver.click(REPORT_PAGE_CHECKBOX_LOC,"Report page checkbox");
	}

	public boolean verifyCountOfDropDownOptionsOnReportPage(int totalOptions){
	...
	public void selectOptionFromDropDown() throws InterruptedException{
		...
		driver.clickByJS(RFWebsiteDriver.driver,REPORT_PAGE_DROPDOWN_SELECT_LOC,"Report Page dropdown");
		driver.waitForElementPresent(REPORT_PAGE_DROPDOWN_SELECT_OPTION_LOC);
		driver.click(REPORT_PAGE_DROPDOWN_SELECT_OPTION_LOC,"Report Page dropdown option");
	}
	...
	public StoreFrontReportProblemConfirmationPage enterYourProblemAndSubmit(String problemTextArea){
		...
		driver.click(REPORT_PAGE_SUBMIT_LOC,"Report page submit button");
