...
public class StoreFrontBillingInfoPage extends StoreFrontRFWebsiteBasePage{
	...
	private final By DEFAULT_BILLING_ADDRESSES_LOC = By.xpath("//input[@class='paymentAddress' and @checked='checked']/ancestor::*/p[1]/span[1]");
	...
	public void clickAddNewBillingProfileLink() {
		...
		driver.clickByJS(RFWebsiteDriver.driver,ADD_NEW_BILLING_LINK_LOC,"Add new billing link");
		driver.click(ADD_NEW_BILLING_LINK_LOC,"Add new billing link");
...
//	}
	...
	public void selectNewBillingCardAddress(){
		...
		driver.clickByJS(RFWebsiteDriver.driver, ADD_NEW_BILLING_CARD_ADDRESS_DD_LOC,"New billing card address drop down");
		driver.waitForElementPresent(ADD_NEW_BILLING_CARD_ADDRESS_DD_FIRST_VALUE_LOC);
		driver.click(ADD_NEW_BILLING_CARD_ADDRESS_DD_FIRST_VALUE_LOC,"New billing card address");
	}

	public void selectUseThisBillingProfileFutureAutoshipChkbox(){
		driver.scrollDownIntoView(USE_THIS_BILLING_PROFILE_FUTURE_AUTOSHIP_CHKBOX_LOC);
		driver.pauseExecutionFor(2000);
		driver.click(USE_THIS_BILLING_PROFILE_FUTURE_AUTOSHIP_CHKBOX_LOC,"Checkbox for Use this billing profile for future autoship");
	}
	...
	public void clickOnEditBillingProfile() throws InterruptedException{
		...
		driver.click(By.xpath("//div[@id='multiple-billing-profiles']//input[@checked='checked']/preceding::p[1]/a"),"Edit billing profile link");
		driver.waitForPageLoad();
	}
	...
	public void clickOnEditOfFirstBillingProfile(){
		...
		driver.click(By.xpath("//div[@id='multiple-billing-profiles']/div[1]//a[contains(text(),'Edit')]"),"First billing profile's edit link");
		driver.waitForPageLoad();
	}
...
public void clickOnSaveBillingProfile(){
	driver.scrollUpIntoView(By.id("submitButton"));
	driver.clickByJS(RFWebsiteDriver.driver,By.id("submitButton"),"submit button");
	driver.waitForLoadingImageToDisappear();
	driver.pauseExecutionFor(5000); //is required
}
...
public void makeBillingProfileDefault(String firstName) throws InterruptedException{
	...
	driver.click(By.xpath("//span[contains(text(),'"+firstName+"')]/following::span[@class='radio-button billtothis'][1]/input/.."), "Default Radio Button");
	driver.waitForLoadingImageToDisappear();
