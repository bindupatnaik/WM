...
public class CSCockpitAutoshipSearchTabPage extends CSCockpitRFWebsiteBasePage{
	...
	public void clickTemplateStatusDropDown(){
		...
		driver.clickByJS(RFWebsiteDriver.driver, TEMPLATE_STATUS_DD_IMG_LOC,"");
	}
	...
	public void clickSearchByDropDown(){
		...
		driver.waitForElementPresent(SEARCH_BY_DD_IMG_LOC);
		driver.click(SEARCH_BY_DD_IMG_LOC,"");
	}
	
	public void clickSearchAutoshipButton() {
		driver.quickWaitForElementPresent(SEARCH_AUTOSHIP_BUTTON_LOC);
		driver.click(SEARCH_AUTOSHIP_BUTTON_LOC,"Search autoship button");
		driver.waitForCSCockpitLoadingImageToDisappear(50);
		driver.waitForElementToBeVisible(TOTAL_CUSTOMERS_FROM_RESULT_FIRST_PAGE,40);
	}
	
	public void enterCustomerNameOrCID(String customerName){
		driver.waitForElementNotPresent(CUSTOMER_NAME_TXT_AREA_LOC);
		driver.click(CUSTOMER_NAME_TXT_AREA_LOC, "customer name");
	...
	public String getLastOrderStatus(String customerSequenceNumber){
		driver.waitForCSCockpitLoadingImageToDisappear();
		driver.waitForElementToBeInVisible(By.xpath(String.format(lastOrderStatusResultsLoc, customerSequenceNumber)),10);
